(function() {
  ...
  function setActivePage(page) {
    currentPage = page;
    [pageDashboard, pagePrediction, pageCommunity].forEach(btn => { btn?.classList.remove('page-active'); btn?.classList.add('opacity-60'); });
    const activeBtn = { 'dashboard': pageDashboard, 'prediction': pagePrediction, 'community': pageCommunity }[page];
